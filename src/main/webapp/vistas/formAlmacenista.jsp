        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg">Sistema Inventario</span>
                </a>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs">${almacenista.nombre}</span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="user-header">
                                        <img src="dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                                        <p>
                                            Bienvenido - ${almacenista.nombre}
                                            <small>Usted es - ${almacenista.id_rol.nombre_rol}</small>
                                        </p>
                                    </li>
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            <h6 class="d-block">${almacenista.nombre}</h6>
                        </div>
                    </div>
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="ProductoController?accion=listarActivos" class="nav-link">
                                            <i class="fas fa-minus nav-icon"></i>
                                            <p>Productos Activos</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="ProductoController?accion=listar" class="nav-link">
                                            <i class="fas fa-minus nav-icon"></i>
